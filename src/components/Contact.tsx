...
const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Create form data to send via mail to
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2 animate-fade-in-up">
            <div className="underwater-card rounded-xl shadow-md p-8 h-full">
              <h3 className="heading-md mb-6 text-foreground">Contact Information</h3>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:nallamothubhanuteja110@gmail.com" className="text-muted-foreground hover:text-primary transition-colors">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="tel:+919392465787" className="text-muted-foreground hover:text-primary transition-colors">
                      +91 93924 65787
                    </a>
                  </div>
                </div>
              ...
              <div className="mt-12">
                ...
                <div className="flex space-x-4">
                  <a 
                    ...
                    className="w-10 h-10 rounded-full bg-muted hover:bg-primary transition-colors flex items-center justify-center text-muted-foreground hover:text-primary-foreground"
                  >
          ...
          <div className="lg:col-span-3 animate-fade-in-up" style={{ animationDelay: "0.3s" }}>
            <div className="underwater-card rounded-xl shadow-md p-8">
              <h3 className="heading-md mb-6 text-foreground">Send Me a Message</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-lg border border-border bg-background text-foreground focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary/50"
                      required
                    />
                  </div>
                  <div>
