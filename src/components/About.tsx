        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative animate-fade-in-up">
            <div className="relative max-w-md mx-auto">
              ...
              <div className="absolute inset-0 border-8 border-primary rounded-2xl transform rotate-3 -z-10"></div>
              <div className="absolute inset-0 border-8 border-secondary rounded-2xl transform -rotate-2 -z-10"></div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              ...
              <div className="flex items-center p-4 bg-card rounded-lg shadow-sm">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Full-Stack Apps</p>
                </div>
              </div>
              ...
              <div className="flex items-center p-4 bg-card rounded-lg shadow-sm">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Multiple Fields</p>
                </div>
              </div>
            </div>
